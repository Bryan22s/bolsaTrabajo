...
/**
 * RegistroOferente: formulario para que una persona se registre como oferente.
 */
function RegistroOferente() {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true)
    try {
      const response = await fetch(`${BACKEND}/api/oferentes/registro`, {
        method: 'POST',
      ...
      <div className="form-card">
        <div className="form-row">
          <div className="form-group">
            ...
            <input
              name="cedula"
              value={oferente.cedula}
              onChange={handleChange}
              placeholder="1-XXXX-XXXX"
        ...
        <div className="form-group">
          ...
          <input
            ...
            value={oferente.lugarResidencia}
            onChange={handleChange}
