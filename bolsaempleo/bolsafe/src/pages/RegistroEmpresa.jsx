...
/**
 * RegistroEmpresa: formulario para que una empresa se registre en el sistema.
 * El registro queda pendiente de aprobación por el administrador.
 */
function RegistroEmpresa() {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true)
    try {
      const response = await fetch(`${BACKEND}/api/empresas/registro`, {
        method: 'POST',
